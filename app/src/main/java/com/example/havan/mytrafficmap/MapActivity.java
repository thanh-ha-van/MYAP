...
public class MapActivity extends AppCompatActivity implements GoogleMap.OnMyLocationButtonClickListener, LocationListener {
    ...
    private String getEnabledLocationProvider() {
        ...
        if (!enabled) {
            ...
            Log.i(Global.MYTAG, "No location provider enabled!");
            return null;
        }
        return bestProvider;
    }
    ...
    private void showMyLocation() {
        ...
        // Android API >= 23 have to catch SecurityException.
            ...
            Log.e(Global.MYTAG, "Show My Location Error:" + e.getMessage());
            e.printStackTrace();
            return;
        }
        ...
        if (myLocation != null) {
            ...
            Marker currentMarker = Global.myMap.addMarker(option);
            currentMarker.showInfoWindow();
        } else {
            Toast.makeText(this, "Location not found!", Toast.LENGTH_LONG).show();
            Log.i(Global.MYTAG, "Location not found");
        }
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (accessCoarsePermission != PackageManager.PERMISSION_GRANTED
                ...
                ActivityCompat.requestPermissions(this, permissions,
                        Global.REQUEST_ID_ACCESS_COURSE_FINE_LOCATION);
